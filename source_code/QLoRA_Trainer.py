...
class ModernRezSLMApp(ctk.CTk):
    ...
    def show_step_3b_training(self):
        ...
        ctk.CTkLabel(self.custom_inputs_frame, text="Learning Rate:", font=ctk.CTkFont(family="Inter", size=11), text_color="#94A3B8").grid(row=0, column=2, sticky="w")
        ...
        self.tr_lr_entry.grid(row=0, column=3, padx=(4, 12), sticky="w")

        ctk.CTkLabel(self.custom_inputs_frame, text="Max Steps:", font=ctk.CTkFont(family="Inter", size=11), text_color="#94A3B8").grid(row=0, column=4, sticky="w")
    ...
    def _on_training_completed(self):
        ...
        self.tr_progress_lbl.configure(text="Training finished / stopped.", text_color="#94A3B8")
